...
class DividerLine {
  ...
  @override
  int get hashCode => isHorizontal.hashCode ^ position.hashCode ^ length.hashCode;
}
          ...
          builder: (context, constraints) {
            return Stack(
              children: [
                ...
                //   Positioned(
                //     left: _selectedElement!.position.dx + _selectedElement!.size.width + 10,
                //     top: _selectedElement!.position.dy,
                //     child: _buildDirectionalControls(constraints),
                //   ),
