...
class DividerLine {
  ...
  @override
  int get hashCode => isHorizontal.hashCode ^ position.hashCode ^ length.hashCode ^ color.hashCode;
}
          ...
          builder: (context, constraints) {
            return Stack(
              children: [
                ...
                GestureDetector(
                  onPanStart: (details) {
                    if (_editMode && _positionEditMode && _multiSelectMode) {
                      setState(() {
                  ...
                  onPanEnd: (details) {
                    if (_editMode && _positionEditMode && _multiSelectMode && _startPoint != null) {
                      final selectionRect = Rect.fromPoints(_startPoint!, _currentPoint!);
                      setState(() {
                        selectedElements = textElements.where((element) {
                    ...
                    } else if (!_editMode && _startPoint != null && _currentPoint != null) {
                      setState(() {
                  ...
                  child: CustomPaint(
                    painter: DrawingPainter(
                      ...
                      selectionRect: _startPoint != null && _currentPoint != null && _multiSelectMode
          ...
          decoration: BoxDecoration(
            border: Border.all(
              color: isSelected || isMultiSelected 
                ? Colors.blue 
                : Colors.transparent,
              width: isSelected ? 2.0 : 1.0, // Thicker border for primary selection
            ),
...
class DrawingPainter extends CustomPainter {
  ...
  final DividerLine? currentLine; // Add this
...
class _FormattingToolbarState extends State<FormattingToolbar> {
  ...
  // void _showTextAlignment(BuildContext context) {
  //   PopupMenuButton(
  //     itemBuilder: (context) {
